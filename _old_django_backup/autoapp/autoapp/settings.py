...
SECRET_KEY = 'django-insecure-9r^4rpk2nl8$#kkb25%(lb-(_a$+*wdv&j^l1y1kc&2r5i+65&'
...
# settings.py — add this as the last line

   # settings.py
AUTH_USER_MODEL = 'home.CustomUser'  # replace 'yourapp' with your app name